...
{
    /// <inheritdoc />
    public partial class mtginitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderBegin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OrderEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProductReturn = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
